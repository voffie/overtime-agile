...
<template>
  <PuzzleContainer nextRoute="/room/design">
    ...
    <template #puzzleIntro>
      <p>
        The Archive Room feels different from the rest of the office — quieter, tidier, almost too
        perfect.<br /><br />
        ...
        Heartcore always took pride in order. Every document, every wire, every byte — exactly where
        it should be.<br /><br />
        You approach the main archive cabinet — the one used for physical backups before everything
        moved to the cloud.<br /><br />
        You start to open the drawers. Some are unlocked, some refuse to budge…
        <strong>Does it mean something?</strong><br /><br /><br />
    ...
    <template #puzzleImpl="{ completed }">
      ...
      <div class="flexContainer">
        ...
        <div class="board">
          ...
          <input v-model="userCode" maxlength="1" type="text" class="code-input" placeholder="?" />
      ...
      <div class="flexContainer">
        <div>
          <p>
            ...
            A soft metallic sound echoes through the room as the remaining drawers slide open
            automatically.<br /><br />
            ...
            Beneath the box rests a thin, old-fashioned diapositive film slide, marked carefully in
            pen:<br />
            “F.M. — 04/09”<br /><br />
            ...
            It looks like some kind of schematic or layout, but the details are impossible to see
            without the right equipment.<br />
            ...
            As you leave, the cabinet automatically locks behind you — drawers sliding back into
            their perfectly aligned grid with a quiet hum.<br />
          </p>
        </div>
        <div>
