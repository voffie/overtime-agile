  ...
  <PuzzleContainer nextRoute="/room/ending">
    ...
    <template #puzzleIntro>
      <div v-if="selected === null">
        ...
        <p>
          Uhh, it stinks in here. You look to the right - there's a dead cat on the floor. That's
          disgusting, but there's no time to focus on that right now. You need more information.
          There's a laptop on the desk, something must be in there somewhere. Of course there's a
          password to the computer. A code with 4 digits. Maybe there's a clue in the room
          somewhere? Something personal?
        </p>
        <br />
