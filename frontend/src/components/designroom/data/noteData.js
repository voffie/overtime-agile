...
export const noteData = {
  ...
  "riddle1": {
    id: 3,
    imgPath: "/src/assets/img/design-room/img/riddle-1.svg",
    imgAltText: "Riddle about a color, presented as a poem on a background with a faint feather illustration.",
    available: false
  },
  "riddle2": {
    id: 4,
    imgPath: "/src/assets/img/design-room/img/riddle-2.svg",
  ...
  "riddle3": {
    id: 5,
    imgPath: "/src/assets/img/design-room/img/riddle-3.svg",
